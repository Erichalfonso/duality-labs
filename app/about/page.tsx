        ...
        <section className="relative py-12 sm:py-16 md:py-20 overflow-hidden">
          ...
          <div className="max-w-[800px] mx-auto px-4 sm:px-6 relative z-10">
            <div className="space-y-8 sm:space-y-12">
              <div>
                <h2 className="text-xl sm:text-2xl font-medium mb-3 sm:mb-4 tracking-tight">Our approach</h2>
              ...
              <div>
                <h2 className="text-xl sm:text-2xl font-medium mb-3 sm:mb-4 tracking-tight">Why we exist</h2>
                <p className="text-sm sm:text-base text-text-secondary leading-relaxed">
              ...
              <div>
                <h2 className="text-xl sm:text-2xl font-medium mb-3 sm:mb-4 tracking-tight">How we work</h2>
                <p className="text-sm sm:text-base text-text-secondary leading-relaxed">
